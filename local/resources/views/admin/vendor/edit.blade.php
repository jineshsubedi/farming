                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="email" type="email" value="{{$vendor->email}}" id="example-email-input">
                            <div class="text-danger">
                                @if ($errors->has('email'))
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $errors->first('name') }}</strong>
                        ...
                        <div class="form-group">
                            ...
                            <input data-role="tagsinput" class="form-control" name="phone" type="tel" value="{{$vendor->phone}}" id="example-tel-input">
                            <div class="text-danger">
                                @if ($errors->has('phone'))
                                    <span class="text-danger" role="alert">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="address" type="text" value="{{$vendor->address}}" id="example-search-input">
                            <div class="text-danger">
                        ...
                        <div class="form-group">
                            ...
                            @if($vendor->image)
                            <img src="{{asset('images/'.$vendor->image)}}" alt="image of vendor" width="100px;">
                            @endif
                            <div class="text-danger">
                                @if ($errors->has('image'))
                                    <span class="text-danger" role="alert">
